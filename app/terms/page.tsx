        ...
        <section className="mt-6 rounded-3xl border border-slate-800 bg-slate-900 p-7 sm:p-10">
          ...
          <div className="mt-8 space-y-7 text-sm leading-7 text-slate-300">
            <section>
              ...
              <p className="mt-2">
                본 약관은 장군 AI가 제공하는 야구 경기 정보 및 분석 서비스 이용에 관한
            ...
            <section>
              ...
              <p className="mt-2">
                장군 AI는 KBO, MLB, NPB 경기 일정, 통계, 선발투수, 최근 경기,
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                장군 AI에 있습니다. 경기 기록과 팀·선수 관련 권리는 각 권리자에게 있습니다.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                장군 AI는 제공된 정보를 이용해 발생한 직접 또는 간접 손실에 대해 법령상
